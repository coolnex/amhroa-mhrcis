  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-slate-900 via-slate-900 to-slate-800">
      ...
      <div className="relative overflow-hidden bg-gradient-to-r from-slate-900 via-cyan-950 to-slate-900 border-b border-cyan-500/20">
        <div className="absolute inset-0 bg-[url('data:image/svg+xml,%3Csvg width='60'54 height='60' viewBox='0 0 60 60' xmlns='http://www.w3.org/2000/svg'%3E%3Cg fill='none' fill-rule='evenodd'%3E%3Cg fill='%2306b6d4' fill-opacity='0.03'%3E%3Cpath d=M36 34v-4h-2v4h-4v2h4v4h2v-4h4v-2h-4zm0-30V0h-2v4h-4v2h4v4h2V6h4V4h-4zM6 34v-4H4v4H0v2h4v4h2v-4h4v-2H6zM6 4V0H4v4H0v2h4v4h2V6h4V4H6z'/%3E%3C/g%3E%3C/g%3E%3C/svg%3E') opacity-30"></div>  
          ...
          <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-6 gap-4 mt-8">
            ...
            <div className="bg-cyan-500/10 rounded-xl p-4 border border-cyan-500/20">
              ...
              <div className="flex items-center gap-1 mt-1">
                {dashboard.trends && getTrendIcon(dashboard.trends.reformProgress)}
                {dashboard.trends && (
            ...
            <div className="bg-green-500/10 rounded-xl p-4 border border-green-500/20">
              ...
              <div className="flex items-center gap-1 mt-1">
                {dashboard.trends && getTrendIcon(dashboard.trends.sdgProgress)}
                {dashboard.trends && (
