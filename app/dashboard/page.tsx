...
const roleConfig: Record<string, any> = {
  ...
  Coordinator: {
    ...
    quickLinks: [
      { title: "Submit Report", href: "/submissions", description: "Upload new report", icon: FileText },
      { title: "Reform Tracker", href: "/reform-index", description: "Monitor progress", icon: TrendingUp },
      { title: "CSO Coordination", href: "/organizations/collaboration-hub", description: "Partner management", icon: Users },
